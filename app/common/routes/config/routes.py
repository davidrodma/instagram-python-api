...
class Routes:
    ...
    def __init__(self,app:Flask):
        ...
        app.add_url_rule('/instagram/scrape/user-info-by-id', 'instagram.user_info_by_id', InstagramScrapeController.user_info_by_id, methods=['GET'])
        app.add_url_rule('/instagram/scrape/user-recent-posts', 'instagram.user_recent_posts', InstagramScrapeController.user_recent_posts, methods=['GET'])
        app.add_url_rule('/instagram/scrape/user-last-post', 'instagram.user_last_post', InstagramScrapeController.user_last_post, methods=['GET'])
        app.add_url_rule('/instagram/scrape/user-info-and-last-post', 'instagram.user_info_and_last_post', InstagramScrapeController.user_info_and_last_post, methods=['GET'])
        app.add_url_rule('/instagram/scrape/media-url-info', 'instagram.media_url_info', InstagramScrapeController.media_url_info, methods=['GET'])
        app.add_url_rule('/instagram/scrape/media-id-info', 'instagram.media_id_info', InstagramScrapeController.media_id_info, methods=['GET'])
        app.add_url_rule('/instagram/scrape/media-id', 'instagram.media_id', InstagramScrapeController.media_id, methods=['GET'])
        app.add_url_rule('/instagram/scrape/followers', 'instagram.followers', InstagramScrapeController.followers, methods=['GET'])
        app.add_url_rule('/instagram/scrape/followers-in-profile', 'instagram.followers_in_profile', InstagramScrapeController.followers_in_profile, methods=['GET'])
        app.add_url_rule('/instagram/scrape/recent-post-likers', 'instagram.recent_post_likers', InstagramScrapeController.recent_post_likers, methods=['GET'])
        app.add_url_rule('/instagram/scrape/recent-post-likers-by-url', 'instagram.recent_post_likers_by_url', InstagramScrapeController.recent_post_likers_by_url, methods=['GET'])
        app.add_url_rule('/instagram/scrape/likers-in-post-by-id', 'instagram.likers_in_post_by_id', InstagramScrapeController.likers_in_post_by_id, methods=['GET'])
        app.add_url_rule('/instagram/scrape/likers-in-post', 'instagram.likers_in_post', InstagramScrapeController.likers_in_post, methods=['GET'])
        app.add_url_rule('/instagram/scrape/post-comments', 'instagram.post_comments', InstagramScrapeController.post_comments, methods=['GET'])
        app.add_url_rule('/instagram/scrape/post-comments-by-id', 'instagram.post_comments_by_id', InstagramScrapeController.post_comments_by_id, methods=['GET'])
        app.add_url_rule('/instagram/scrape/comments-in-post', 'instagram.comments_in_post', InstagramScrapeController.comments_in_post, methods=['GET'])
        app.add_url_rule('/instagram/scrape/comment-in-last-post', 'instagram.comment_in_last_post', InstagramScrapeController.comment_in_last_post, methods=['GET'])
        app.add_url_rule('/instagram/scrape/user-commented-in-post', 'instagram.user_commented_in_post', InstagramScrapeController.user_commented_in_post, methods=['GET'])
