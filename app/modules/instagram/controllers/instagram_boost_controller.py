...
from app.modules.instagram.dto.save_boost_dto import SaveBoostDto
...
from app.modules.instagram.services.instagram_boost_service import InstagramBoostService
from app.common.utilities.json_enconder import JSONEncoder

class InstagramBoostController(Controller):
    service = InstagramBoostService()    


    @classmethod
    async def save(self):
        try:
            dto = SaveBoostDto(**request.get_json())
            info = await self.service.save(
            ...
            return ExceptionUtility.catch_response(e,f'Error ctrl.save')
